...
>
> **Last Generated**: 2026-05-20T08:50:20.953Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-sticker-list` | Request/Response | Return the list of stickers (image files) from the configured folder. Each entry includes a base64 data URL so the renderer can show thumbnails and rebuild a File for synthetic-paste insertion without needing direct filesystem access. | [`app/customStickers/index.js:30`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/customStickers/index.js#L30) |
